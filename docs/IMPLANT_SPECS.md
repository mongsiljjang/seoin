...
| 부품 | 두께 | 둘째 축 |
|---|---|---|
| 픽스처 | 3.0 · 3.5 · 3.8 · 4.0 · 4.5 · 5.0 · 5.5 | 길이 6 · 7 · 8.5 · 10 · 11.5 · 13 · 15 |
| 힐링캡 | 4.0 · 4.5 · 5.0 · 5.5 · 6.0 · 6.5 | GH 2 · 3 · 4 · 5 · 6 · 7 |
| 어버트먼트 | 4.0 · 4.5 · 5.0 · 5.5 · 6.0 · 6.5 | 높이 1 · 2 · 3 · 4 · 5 · 6 |

처음에는 오스템 TS III 만 보고 좁게 잡았는데, 화면에 칩이 세 개밖에 안 떠서
넓혔다. 3.8 은 사용자 데이터에 실제로 있던 값이다(덴티움 계열).
**규격 추가 화면의 칩도 이 눈금을 그대로 쓴다** — 전에는 이미 등록된 규격에서만
뽑아서, 새 병원이 열면 고를 것이 없었다.
...
**표의 두께·길이 숫자를 누르면 그 줄을 뺀다.** 다만 그 줄에 규격이 하나라도
있으면 빼지 않는다 — 눈금이 사라지면 그 줄의 재고가 화면에서 통째로 안 보인다.
규격을 먼저 지우게 안내한다.

**잘못 만든 칸(규격)** 은 규격 수정에서 지운다. 아무것도 움직인 적 없는 칸은
그냥 지우고, 매입·사용·이월·현재고가 남은 칸은 **무엇을 잃는지 보여주고**
확인을 받는다. 기록이 남은 규격이 조용히 사라지면 대사가 통째로 어긋난다.
